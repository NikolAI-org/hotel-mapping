...
def main():
    ...
    hadoopConf.set("fs.s3a.endpoint", "http://seaweed-s3.local")
    # hadoopConf.set(
    #     "fs.s3a.endpoint", "http://seaweedfs-s3.delta-store.svc.cluster.local:8333"
    # )
    ...
    # print("Hadoop version (runtime):", jvm.org.apache.hadoop.util.VersionInfo.getVersion())
    # print("Hadoop build version:", jvm.org.apache.hadoop.util.VersionInfo.getRevision())
    # print("Hadoop common jar:", jvm.org.apache.hadoop.fs.FileSystem.getFileSystemClass("s3a", jvm.org.apache.hadoop.conf.Configuration()).getProtectionDomain().getCodeSource().getLocation())

    # debug_s3a_conf(spark)
    # List buckets / warehouse dir
    # hadoop_conf = spark._jsc.hadoopConfiguration()
    # print(hadoop_conf.get("fs.s3a.access.key"))  # should print 'admin'
    # print(hadoop_conf.get("fs.s3a.secret.key"))  # should print 'password'
