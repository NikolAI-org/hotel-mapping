...
hotel_struct_schema = StructType(
    [
        StructField(
            "hotels",
            ArrayType(
                StructType(
                    [
                        ...
                        StructField(
                            ...
                            StructType(
                                [
                                    ...
                                    StructField(
                                        "phones", ArrayType(StringType()), True
                                    ),
                                    StructField("fax", ArrayType(StringType()), True),
                                    StructField(
                                        "emails", ArrayType(StringType()), True
                                    ),
                                ]
                            ),
                            True,
                        ),
                        StructField("chainCode", StringType(), True),
                        StructField("chainName", StringType(), True),
                        ...
                        StructField(
                            "availableSuppliers", ArrayType(StringType()), True
                        ),
                    ]
                )
            ),
