"""
Spark Job: [TEST] Map Raw JSON Hotel Data to Parquet Format
This script reads JSON hotel data from MinIO, applies schema mapping,
and writes to Parquet format for efficient querying.

Input: s3a://test-data-lake/raw_input/{country}/{supplier_name}/*.json
Output: s3a://test-data-lake/mapped_input/{country}/{supplier_name}/
"""
...
raw_input_path = f"s3a://test-data-lake/raw_input/{country}/{supplier_name}/"
mapped_output_path = f"s3a://test-data-lake/mapped_input/{country}/{supplier_name}/"
